// SonicProject.cpp : 응용 프로그램에 대한 진입점을 정의합니다.
//
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.lpszMenuName = NULL;// MAKEINTRESOURCEW(IDC_SONICPROJECT);
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   SetWindowPos(g_hWnd, NULL, 200, 100, rt.right-rt.left, rt.bottom-rt.top,NULL);
